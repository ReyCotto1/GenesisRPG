...
**** Habilidad: [Descendiente de la Familia Hendo Lok] 
     - Obliga al usuario a gastar un punto mas en la caracteristica de [Aguante],
       en cambio, permite un nivel extra en la misma.
...
**** Habilidad: [Descendiente de la Familia Lo Po Bia] 
     - Obliga al usuario a portar la disciplina del [Control Animal],
       en cambio, permite un nivel extra en la misma. 
...
**** Habilidad: [Descendiente de la Familia Tu Perie] 
     - Obliga al usuario a portar la disciplina de la [Maestria en Faros],
       en cambio, permite un nivel extra en la misma. 
